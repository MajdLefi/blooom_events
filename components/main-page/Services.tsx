                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12} md={8}>
                                <Box sx={{ width: '100%', height: '100%', zIndex: 99 }}>
                                    ...
                                    <Typography sx={{ fontSize: '21.5px', fontFamily: 'Inika', color:'black' }}>Elevating your digital presence, our social media <br/> management service engages, and sparks conversations </Typography>
                                </Box>
                            </Grid>
                        </Grid>
                    </Tabs.Item>
